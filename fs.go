...
func (d Dir) Mkdir(ctx context.Context, name string, perm os.FileMode) error {
	...
	if d.Config.Log.Create {
		fmt.Println("Created directory: " + name + " for user: " + d.resolveUser(ctx))
	}
...
func (d Dir) OpenFile(ctx context.Context, name string, flag int, perm os.FileMode) (webdav.File, error) {
	...
	if d.Config.Log.Read {
		fmt.Println("Opened file: " + name + " for user: " + d.resolveUser(ctx))
	}
...
func (d Dir) RemoveAll(ctx context.Context, name string) error {
	...
	if d.Config.Log.Delete {
		fmt.Println("Deleted file or directory: " + name + " for user: " + d.resolveUser(ctx))
	}
...
func (d Dir) Rename(ctx context.Context, oldName, newName string) error {
	...
	if d.Config.Log.Update {
		fmt.Println("Renamed file or directory: " + oldName + " to " + newName + " for user: " + d.resolveUser(ctx))
	}
